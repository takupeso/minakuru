export default {
  ...
  methods: {
    getPrefecturesList: function() {
      return this.prefectures
    },
    getPrefectureName: function(id) {
      for(var prefecture in this.prefectures) { // オブジェクトの中のプロパティ名を取り出す。
        if(id == this.prefectures[prefecture].id){
          return this.prefectures[prefecture].name
        }
      }
      return false
    }
